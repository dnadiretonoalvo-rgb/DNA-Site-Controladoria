        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-white leading-tight mb-4">
              Por que confiar a governança da sua empresa à DNA - Direto no Alvo?
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-5">
              ...
              <div className="text-sm sm:text-base text-slate-600 leading-relaxed space-y-4">
                ...
                <p>
                  A <strong>DNA - Direto no Alvo Governança Operacional</strong> atua como um parceiro estratégico que estrutura, organiza e acompanha essas três dimensões essenciais — <strong>Contratos, Fornecedores e Compliance</strong> —, permitindo que a gestão tenha segurança para continuar expandindo o negócio.
                </p>
